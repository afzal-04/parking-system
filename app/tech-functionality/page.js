  ...
  return (
    <div className={styles.shell}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <div className={styles.submissionBadge}>
            ...
            <span>🗺️ {lang === "hi" ? "रोडमैप: माह 3 + माह 4+" : "Roadmap: Month 3 + Month 4+"}</span>
          </div>
        </div>
      </section>
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.problemGrid}>
            {[
              ...
              { icon: "🅿️", title: lang === "hi" ? "कानूनी पार्किंग की अनजानी स्थिति" : "Legal parking underused", desc: lang === "hi" ? "नागरिकों को कानूनी पार्किंग स्थल पता नहीं होते।" : "Legal parking zones are underused because citizens have no way to find nearby availability." },
        ...
        <section className={styles.section}>
          <div className={styles.sectionHead}>
            <h2>🏗️ {lang === "hi" ? "सिस्टम आर्किटेक्चर" : "System Architecture"}</h2>
          ...
          <div className={styles.archCard}>
            ...
            <div className={styles.archArrow}>↓</div>
            <div className={styles.archDbRow}><div className={styles.archDbBox}>🗃️ {lang === "hi" ? "केंद्रीय डेटाबेस" : "Central Database"}</div></div>
            <div className={styles.archArrow}>↓</div>
            <div className={styles.archAdminBox}>🛡️ {lang === "hi" ? "पुलिस / एडमिन कमांड डैशबोर्ड" : "Admin / Police Command Dashboard"}</div>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.flowGrid}>
            <div className={styles.flowCard}>
              ...
              <div className={styles.flowNote}>ℹ️ {lang === "hi" ? "शिकायत सूची या मैप कभी सार्वजनिक नहीं — जानबूझकर न्यूनतम नागरिक अनुभव।" : "No complaint list or map is ever shown publicly — intentionally minimal citizen experience."}</div>
            </div>
            <div className={styles.flowCard}>
              ...
              <div className={styles.flowNote}>⚠️ <strong>{lang === "hi" ? "सॉफ्टवेयर सिमुलेशन:" : "Software simulation:"}</strong> {lang === "hi" ? "इस चरण में कोई वास्तविक एम्बुलेंस डिस्पैच सिस्टम एकीकरण नहीं है।" : "No real ambulance dispatch system integration exists at this stage."}</div>
            </div>
            <div className={styles.flowCard}>
              <div className={styles.flowCardHead}>🅿️ {lang === "hi" ? "पार्किंग खोज फ्लो" : "Find-Parking Flow"}</div>
              <div className={styles.flowSteps}>
        ...
        <section className={styles.section}>
          <div className={styles.sectionHead}>
            ...
            <h2>🅿️ {lang === "hi" ? "स्मार्ट पार्किंग सिस्टम — विस्तृत विवरण" : "Smart Parking System — Detail"}</h2>
        ...
        <section className={styles.section}>
          <div className={styles.sectionHead}>
            ...
            <div className={styles.simWarning}>
              ⚠️ <strong>{lang === "hi" ? "स्पष्ट सूचना:" : "Explicit notice:"}</strong>{" "}
          ...
          <div className={styles.pipelineGrid}>
            {[
              ...
              { step: "8", icon: "🗺️", titleEn: "Heatmap Analysis", titleHi: "हीटमैप विश्लेषण", descEn: "Violations broken down by location, day, time-of-day, and repeat offenders.", descHi: "स्थान, दिन, दिन के समय और बार-बार अपराधियों द्वारा उल्लंघन का विश्लेषण।" },
            ].map((item, i) => (
        ...
        <section className={styles.section}>
          <div className={styles.sectionHead}>
            <h2>⚙️ {lang === "hi" ? "तकनीकी स्टैक" : "Technology Stack"}</h2>
          ...
          <div className={styles.stackGrid}>
            {[
              ...
              { icon: "🗺️", name: "Leaflet.js + OpenStreetMap", descEn: "For GIS mapping. Explicitly chosen over Google Maps to avoid metered API billing risk. Fully open-source, no API key charges.", descHi: "GIS मैपिंग के लिए। Google Maps के बजाय जानबूझकर चुना — मीटर्ड API बिलिंग जोखिम से बचने के लिए। पूरी तरह से ओपन-सोर्स।" },
        ...
        <section className={styles.section}>
          ...
          <div className={styles.roadmapList}>
            {[
              ...
              { monthEn: "Month 3", monthHi: "माह 3", status: "roadmap", labelEn: "🗺️ Roadmap", labelHi: "🗺️ रोडमैप", titleEn: "AI Pilot (Module 2)", titleHi: "AI पायलट (मॉड्यूल 2)", itemsEn: ["Pilot cameras", "Digital no-parking zones", "Vehicle detection", "ANPR", "Officer alerts + warnings"], itemsHi: ["पायलट कैमरे", "डिजिटल नो-पार्किंग ज़ोन", "वाहन डिटेक्शन", "ANPR", "ऑफिसर अलर्ट + चेतावनी"] },
              { monthEn: "Month 4+", monthHi: "माह 4+", status: "roadmap", labelEn: "🗺️ Roadmap", labelHi: "🗺️ रोडमैप", titleEn: "Scale + Automate", titleHi: "स्केल + स्वचालन", itemsEn: ["IoT sensors", "Online payment + reservations", "Full challan integration", "Traffic analytics"], itemsHi: ["IoT सेंसर", "ऑनलाइन भुगतान + आरक्षण", "पूर्ण चालान एकीकरण", "ट्रैफिक एनालिटिक्स"] },
            ].map((r, i) => (
        ...
        <div className={styles.disclaimerBox}>
          <strong>⚠️ {lang === "hi" ? "हैकाथॉन सबमिशन नोट:" : "Hackathon Submission Note:"}</strong>{" "}
